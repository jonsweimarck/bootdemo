...
BootDemo tries to adhere as closely as possible to standard HTTP and REST conventions in its
...
[[api-complaints-access]]
=== Listing Complaints

A `GET` request will list all the complaints

==== Response structure

include::{snippets}/complaints-example/response-fields.adoc[]

==== Example request

include::{snippets}/complaints-example/curl-request.adoc[]

==== Example response

include::{snippets}/complaints-example/http-response.adoc[]
